...
import com.office.taskmanager.Pojo.UserRoles;
...
public class EssentialsFragment extends Fragment implements RestfulListener {
    ...
    private ImageView profile_camera;
    private CircleImageView image;
    private LinearLayout companyNames;
    ...
    private TextView click, camera, sdCard;
    ...
    private EditText mPassword, mMobileNo, mEmail, mfirstName, mlastName;
    private String passwords;
    private String email, firstname, secondname, phonenumber, password;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.essentials_activity, container, false);
    ...
    private void intialVariables() {
        companyNames = (LinearLayout) view.findViewById(R.id.companyNames);
        mMobileNo = (EditText) view.findViewById(R.id.Mobile);
        image = (CircleImageView) view.findViewById(R.id.display_image);
        profile_camera = (ImageView) view.findViewById(R.id.profile_camera);
        mEmail = (EditText) view.findViewById(R.id.emailAndMobile);
        mfirstName = (EditText) view.findViewById(R.id.firstName);
        mlastName = (EditText) view.findViewById(R.id.lastName);
        mPassword = (EditText) view.findViewById(R.id.add_password);
        passwords = mPassword.getText().toString();
        essentialBranches = (Spinner) view.findViewById(R.id.txt_exxentinalBranches);
        mSubmit = (Button) view.findViewById(R.id.submit);
        mUserRoles = (Spinner) view.findViewById(R.id.user_roles);
        clickListener();
    }

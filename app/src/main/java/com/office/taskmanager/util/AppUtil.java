...
public class AppUtil {
    /*MultiTask ArrayList*/
    public static ArrayList<MultiTask> multiTasks = new ArrayList<>();
    public static ArrayList<MultiTask> getMultiTasks() {
        return multiTasks;
    }

    public static void setMultiTasks(ArrayList<MultiTask> multiTasks) {
        AppUtil.multiTasks = multiTasks;
    }
/*****************************************************************************/

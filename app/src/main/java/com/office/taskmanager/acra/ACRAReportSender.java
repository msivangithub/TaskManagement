package com.office.taskmanager.acra;
...
import com.office.taskmanager.application.MyTaskManagerApplication;
...
public class ACRAReportSender implements ReportSender {
    ...
    public void send(CrashReportData report)
        ...
        try {
            ...
            gMailSender.sendMail(MyTaskManagerApplication.getProperties().getProperty("SUBJECT")
                            .toString(),
                    reportBody, emailUsername,
                    MyTaskManagerApplication.getProperties().getProperty("RECEPENTS").toString());
        } catch (Exception e) {

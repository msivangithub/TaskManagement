...
import com.office.taskmanager.activity.UserActivity;
...
public class AllUsersAdapter extends RecyclerView.Adapter<AllUsersAdapter.MyViewHolder> implements RestfulListener, SectionTitleProvider ,RecyclerViewFastScroller.BubbleTextGetter {
    ...
    public void setFilter(ArrayList<TaskUser> taskList) {
        taskUserArrayList = new ArrayList<>();
        taskUserArrayList.addAll(taskList);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        try {
            Glide.with(context) .load(ProjectVariables.IMAGE_PATH + taskUserArrayList.get(position).getImage())
                    .thumbnail(0.5f)
                    .crossFade()

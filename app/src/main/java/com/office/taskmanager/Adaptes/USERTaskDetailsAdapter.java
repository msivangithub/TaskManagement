...
import com.office.taskmanager.activity.UserTaskDetailsActivity;
...
public class USERTaskDetailsAdapter extends RecyclerView.Adapter<USERTaskDetailsAdapter.MyViewHolder> implements RestfulListener, RecyclerViewFastScroller.BubbleTextGetter {
    ...
    public void setFilter(List<Task> taskList) {
        billToBillArrayList = new ArrayList<>();
        billToBillArrayList.addAll(taskList);
        ...
        public MyViewHolder(View convertView) {
            ...
            taskrow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra(TASK_IMAGE, billToBillArrayList.get(getAdapterPosition()).getTaskimage());
                    intent.putExtra(TASK_VIDEO, billToBillArrayList.get(getAdapterPosition()).getVideo());

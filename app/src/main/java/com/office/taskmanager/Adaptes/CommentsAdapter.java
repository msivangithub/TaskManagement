...
public class CommentsAdapter extends RecyclerView.Adapter<CommentsAdapter.MyViewHolder> {
        ...
        public MyViewHolder(View itemView) {
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    try {
                        Glide.with(context).load(ProjectVariables.IMAGE_PATH + commentsList.get(getAdapterPosition()).getProfile())
                                .thumbnail(0.5f)
                                .crossFade()
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        try {
            Glide.with(context).load(ProjectVariables.IMAGE_PATH + commentsList.get(position).getProfile())
                    .thumbnail(0.5f)
                    .crossFade()
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
            ...
            switch (menuItem.getItemId()) {
                case R.id.capture_video:
                    if (commentsList.get(position).getVideo().isEmpty() || commentsList.get(position).getVideo().equalsIgnoreCase("") || commentsList.get(position).getVideo().length() == 0 || commentsList.get(position).getVideo().equalsIgnoreCase("novideo")) {
                        ...
                        showVideo.show();
                        /*VideoView*/
                        final VideoView videoview = (VideoView) showVideo.findViewById(R.id.videoPreview);
                ...
                case R.id.capture_image:
                    if (commentsList.get(position).getImage().isEmpty() || commentsList.get(position).getImage().equalsIgnoreCase("") || commentsList.get(position).getImage().length() == 0) {
                       ...
                       /* LoadImageFromURL loadImage = new LoadImageFromURL();
                        ...
                        DisplayImage(commentsList.get(position).getImage());
                    }
                    break;
    ...
    private void DisplayImage(String images) {
        Dialog showimage = new Dialog(context);
        showimage.requestWindowFeature(Window.FEATURE_NO_TITLE);
        showimage.setContentView(R.layout.showimage);
        WindowManager.LayoutParams lp = new WindowManager.LayoutParams();
        ...
        lp.height = WindowManager.LayoutParams.MATCH_PARENT;
        showimage.show();
        final ImageView image = (ImageView) showimage.findViewById(R.id.showImage);
        zoom = (ZoomControls) showimage.findViewById(R.id.zoomControls1);
        zoom.setOnZoomInClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        try {
            Glide.with(context).load(ProjectVariables.IMAGE_PATH + images)
                    .thumbnail(0.5f)
                    .crossFade()
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                    .into(image);

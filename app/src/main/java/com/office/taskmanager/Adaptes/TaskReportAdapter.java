...
public class TaskReportAdapter extends RecyclerView.Adapter<TaskReportAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView ActEndDate, ActStartDate, TaskHeading, TaskStatus, cid,priority;
    ...
    public void onBindViewHolder(final MyViewHolder viewHolder, final int position) {
        ...
        viewHolder.priority.setText(t.getPriority());
        viewHolder.cid.setText(t.getCid());
        if (position % 2 == 0) {
            viewHolder.itemView.setBackgroundColor(Color.parseColor("#ffffff"));
        } else {
            viewHolder.itemView.setBackgroundColor(Color.parseColor("#0097A7"));
        }

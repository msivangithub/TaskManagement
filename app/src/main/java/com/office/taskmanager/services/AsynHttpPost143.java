...
public class AsynHttpPost143 extends AsyncTask<Void, Void, String> {
    ...
    boolean isConnected;
    private String pdTemp;
    private boolean _firstTime;

    public AsynHttpPost143(Context con, int requestId, int requestType, String apiMethod, RestfulListener listener, JSONObject obj, String temp2, boolean firstTime) {
        _con = con;

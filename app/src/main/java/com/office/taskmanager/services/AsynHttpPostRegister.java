 ...
 */
public class AsynHttpPostRegister extends AsyncTask<Void, Void, String> {
    ...
    public AsynHttpPostRegister(Context con, int requestId, int requestType, String apiMethod, RestfulListener listener, JSONObject obj, String temp2) {
        _con = con;
    ...
    protected String doInBackground(Void... params) {
        ...
        String MainUrl = ProjectVariables.MASTER_URL + _apiMethod;
        String result = null;
        HttpPost post = null;
